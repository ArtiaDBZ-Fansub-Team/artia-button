            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="https://space.bilibili.com/511613155/" target="_blank"><img src="resources/Bilibili_icon.png" height="18"/></a></li>
                        <li><a href="https://twitter.com/Artia_Hololive" target="_blank"><img src="resources/Twitter_Social_Icon_Circle_Color.png" height="18"/></a></li>
                        <li><a href="https://www.twitch.tv/artia_hololive" target="_blank"><img src="resources/Twitch_icon.png" height="18"/></a></li>
                    </ul>
        ...
        <footer class="footer">
            <div class="container-fluid footer-content">
                <div class="pull-right">
                    <div class="text-right"><a href="https://github.com/BattleWoLFz99/artia-button" target="_blank">{{$t("info.toGithub")}} <img src="https://img.shields.io/github/stars/BattleWoLFz99/artia-button.svg?style=social"/></a></div>
                    <div class="text-right">{{$t("info.notOfficial")}}</div>
                </div>
                <div>{{$t("info.audioStaff")}}</div>
                <div>❄️大冰碴子组❄️<span style="color: rgba(0, 0, 0, 0.1)">Powered By Meowsound Idols</span></div>
            </div>
        </footer>
  </div>
</template>
